  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch all feedbacks
        const { data: feedbacksData } = await api.get(
          ...
          <div className="animate-fade-in">
            <div className="text-center py-8 sm:py-12">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-error-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <svg
                  className="w-8 h-8 sm:w-10 sm:h-10 text-error-600"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
          ...
          <div className="animate-fade-in">
            <div className="text-center py-8 sm:py-12">
              ...
              <p className="text-gray-500 text-sm sm:text-base">
                There are no admin data to display at this time.
              </p>
            </div>
          </div>
        </div>
          ...
          {activeTab === "metrics" ? (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div
                  className="card-elevated p-4 sm:p-6 hover-lift animate-fade-in-up"
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {metrics.total > 0
                          ? Math.round((metrics.positive / metrics.total) * 100)
                          : 0}
                        % of total
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {metrics.total > 0
                          ? Math.round(
                              (metrics.constructive / metrics.total) * 100
                            )
                          : 0}
                        % of total
                      </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {metrics.total > 0
                          ? Math.round(
                              (metrics.anonymous / metrics.total) * 100
                            )
                          : 0}
                        % of total
                      </p>
              ...
              {/* Summary Section */}
              <div
                className="card-elevated p-4 sm:p-6 lg:p-8 animate-fade-in-up"
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-success-50 to-success-100 rounded-xl border border-success-200">
                    ...
                    <p className="text-xs sm:text-sm font-medium text-success-800">
                      Positive Rate
                    </p>
                  ...
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-warning-50 to-warning-100 rounded-xl border border-warning-200">
                    ...
                    <p className="text-xs sm:text-sm font-medium text-warning-800">
                      Constructive Rate
                    </p>
                  ...
                  <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200 sm:col-span-2 lg:col-span-1">
                    ...
                    <p className="text-2xl sm:text-3xl font-bold text-purple-700 mb-1 sm:mb-2">
                      {metrics.total > 0
                        ? Math.round((metrics.anonymous / metrics.total) * 100)
                        : 0}
                      %
                    </p>
            ...
            <div className="animate-fade-in-up">
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-gray-600 text-sm">
                  Showing all feedbacks in the system
                </p>
              </div>
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 sm:mb-4 space-y-3 sm:space-y-0">
                        <div className="flex items-center space-x-3 sm:space-x-4">
                          <div
                            className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shadow-soft flex-shrink-0 ${
                              fb.type === "positive"
                      ...
                      <div className="mt-3 sm:mt-4 text-xs text-gray-500">
                        <p>
                          <strong>From:</strong> {fb.sender_id}
                        </p>
                        <p>
                          <strong>To:</strong> {fb.receiver_id}
                        </p>
                      </div>
                    </div>
                  ))}
