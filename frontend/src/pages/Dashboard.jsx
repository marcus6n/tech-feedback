...
const Dashboard = () => {
  ...
  const constructiveFeedbacks = feedbacks.filter(
    (fb) => fb.type !== "positive"
  ).length;
          ...
          {feedbacks.length === 0 ? (
            <div className="text-center py-16 animate-fade-in-up">
              ...
              <p className="text-gray-500 mb-8 max-w-md mx-auto text-balance">
                You haven't received any feedback yet. Share your feedback ID
                with your team to start receiving feedback!
              </p>
              <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 max-w-md mx-auto">
                ...
                <div className="bg-white rounded-lg p-3 border border-primary-100">
                  <code className="text-sm font-mono text-primary-700 break-all">
                    {user.id}
                  </code>
                </div>
              </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 space-y-3 sm:space-y-0">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex flex-wrap gap-2 min-w-0 flex-1">
                        <span
                          className={`badge-${
                            fb.type === "positive" ? "success" : "warning"
                          }`}
                        >
                          {fb.type === "positive" ? "Positive" : "Constructive"}
                        </span>
                        {fb.is_anonymous && (
                          <span className="badge-neutral">Anonymous</span>
                        )}
                      </div>
                    </div>
